...
function Point(x, y, z, size, color) {
	...
	this.friction = document.Friction;						//摩擦
	this.rotationForce = document.rotationForce;			//旋转 力度
	this.springStrength = 0.1;								//反弹 力度
...
function makeColor(hslList, fade) {
	var hue = hslList[0] /*- 17.0 * fade / 1000.0*/;		//hue			色调
	var sat = hslList[1] /* + 81.0 * fade / 1000.0 */;		//Saturation	饱和度
	var lgt = hslList[2] /* + 58.0 * fade / 1000.0 */;		//light			亮度
